...
def get_qa_ablation_rewritor_test(input_path, output_path,benchmark, model,corpusfrom,backend,topk=5):
            ...
            if subqestions and type(subqestions) is list:
                ...
                for sub_index, subqestion in enumerate(subqestions):
                    ...
                    try:
                        ...
                        ref = None
                    results = retriever.search(f"{prev_answer}\n{sub_q}", topk=topk)
