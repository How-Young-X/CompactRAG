...
if __name__ == "__main__":
    ...
    retriever.load(f"data/index/QA/{dataset}/corpus.index",
                       f"data/index/QA/{dataset}/corpus_meta.pkl",
                       f"data/index/QA/{dataset}/corpus_meta.db")
    query = "Which country is Jaap Speyer from?"
